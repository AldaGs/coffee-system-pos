  ...
  return (
    <div className="admin-section fade-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '32px', alignItems: 'flex-start' }}>
        ...
        {/* DANGER ZONE SECTION */}
        <div style={{ background: 'rgba(231, 76, 60, 0.05)', padding: '32px', border: '2px dashed rgba(231, 76, 60, 0.3)', borderRadius: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
