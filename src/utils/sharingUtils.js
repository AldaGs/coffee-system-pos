...
// Share an arbitrary Blob (e.g. a vector PDF) via the Web Share API, falling
// back to a download. Used by callers that build their own document (e.g. the
// jsPDF vendor statement).
